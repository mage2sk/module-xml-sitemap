<?php
/**
 * Standalone install + heartbeat reporter for Panth_XmlSitemap.
 *
...
namespace Panth\XmlSitemap\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_XmlSitemap';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-xml-sitemap';
